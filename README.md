...
For this project, I have created a hair salon website with the purpose of informing customers about the business, highlighting services provided and encouraging users to book appointments. By incorporating elements like a service page, contact information section and a booking form as a base, I have achieved the basic requirements of the projects goals.

To achieve a good user experience for this project I have focused on creating a user friendly navigation, provided useful information about the business and added elements that instil customer confidence when booking online. 
...
- Existing customers wanting to explore new services.
- Customers who want to access business information, services and view the salons style range.

# Website Strategy

## Research

As part of my research, I've looked at 3 local hair salon near me to assess their website. Through this research, I've looked at what was done well, what was done bad, what I can gain and what I would improve.

## Websites

### Website 1 [(Hairticians.com)](https://hairticians.getslick.com/index.html)

What is good?

- Has a edgy, modern style
- Showcases what product brands are used by business
- Google reviews available on website
- FAQ section
- Legal section in footer
- Gallery section, images are placed well with a good flow

What is bad? 

- Text on hero banner contrasts badly with image (hard to read)
- Team section has too much information about stylists (could be condensed / simplified)
- Social section isn't responsive on mobile (whatsapp get squished and other icons not centered)

What could I take from this? 

- Good features that would improve my own website, eg; Product brands used.
- Dynamic use of colours (it's bold)

What would I improve?

- Better contrast between text and background (different choice of text colour)
- Minor fixes to responsiveness on different devices (Socials section)


### Website 2 [(Artizanbath)](https://www.artizanbath.co.uk/)

What is good? 

- Good colour contrast
- Interactive images (about, services, stylists, advice)
- Interactive tour of studio
- Instagram links to posts
- Offers section (Student discount)
- Pages have a lot of visual effects
- Advice section is informative and professional
- Shop now for products (opens in new tab)
- Hair Hub, free professional tips

What is bad? 

- Interactive images aren't responsive on all devices
- Shop now doesn't match the original sites aesthetics
- Too much to navigate, bit too much going on

What could I take from this? 

- Interactive and animation elements
- Choice of colour palette
- Advice section

What would I improve?

- Simplify for easier navigation
- Improve responsiveness

### Website 3 ([Cohesion Hair](http://www.cohesionhair.co.uk/))

What is good? 

- Lot of options for navigation, maybe too much?
- Animation elements

What is bad? 

- Home page is very chaotic
- Gallery section broken? No gallery images
- Testismonial section broken as well
- Blog section not in use

What could I take from this? 

- I don't think I would take anything from this website
...
For this project, I used a agile development approach by using Github projects to organise and prioritise the websites features. 
...
Anything highlighted as a must-have is what I have considered as a non-negotiable. These would include creating good accessibility, key features and a user friendly interface. The should-have's have been included as extras that would add value and help achieve the goals of this project. The could-have is an additional feature that adds value but wouldn't be necessary.
...
When deciding a colour palette some factors had to be considered, such as do the colours contrast enough to not affect the visual impared, do they work aesthetically, and do they reflect the businesses brand.
...
I chose these colours because I felt they reflected the brands professionalism and modern vibes. It was important they passed the ratio test on the WebAIM website to ensure accessibility was achieved.

### Typography

For the typography I used GoogleFont's Playfair Display (https://fonts.google.com/specimen/Playfair+Display). Considering the type of business my project is, a Serif font seemed the best option for a more professional and polished look, and used a standard serif font as a secondary backup.
...
The screenshots below are a basic idea of the layout, subject to changes for accessibility, aesthetics and a better user experience.
...
The navbar section is essential to help users easily access areas of the website that they may have been specifically trying to find.

The hero banner was to create a professional look with a call to action to entice potential customers to engage with the business.

### Our Team section
![Home page wireframe: Our team section](/module-1-planning/wireframe-screenshots/main-page/staff-section.png)

The team section was included to welcome the users and give them confidence in the business.

### Testimonials
![Home page wireframe: Testimonials](/module-1-planning/wireframe-screenshots/main-page/testimonials.png)

The testimonials feature is included to increase user confidence in the business by showcasing positive experiences from previous customers.
...
Allows users to view all services the business provides, with clear service names, descriptions and prices.
...
The structure of this project has been designed to support user experience by using a clear and simplistic design, incorporating responsive design among all devices and offering easy and quick navigation to help users find what they're looking for. 
...
- Git, version control
- GitHub, Code hosing and project management
- W3C, Markup and CSS validator
- DevTools, Inspect and Lighthouse
- GoogleFonts, Custom Fonts
- FontAwesome, Icons
- Bootstrap, Used for specific elements of the website

# Testing

## W3C Validators (HTML and CSS)

I used this website for both HTML and CSS checks through out the process of developing my project to ensure any errors were dealt with, so I didn't have to do multiple fixes at the end. 

The main issues I encountered with the HTML validator were generally minor like missing div end tags or incorrect attributes. The only issue I had with the CSS validator were a couple incorrect properties.

## DevTools

DevTools have been an invaluable tool for me during the development of this project. It has been used at every step of the journey to ensure responsiveness between screen sizes, looking at source code to determine where errors may be or finding the right CSS code to make changes.

## Lighthouse

Lighthouse has been used near the end of my project to see what needs to be changed to improve performance, accessibility and best practices. 1 of the issues I found was the performance on the home page, this caused a score of 87 and was down to the images used on the team section. This was a easy fix, all I needed to do was convert the image from a jpeg to a webp file.

## GitHub Pages

This project is accessible through GitHub Pages. By deploying through this I can see issues that wouldn't be known through preview options on the IDE used. This also allows others to view my project on a browser without having to copy the code and run it manually.
...
By having all pages accessible straight away from the navigation bar, increases the likelihood of the users finding the content they need and remaining on the site longer. 
